package cn.qiluno.train.generator.util;
...
public class DBUtil {
    ...
    public static String sqlTypeToJavaType(String sqlType) {
        ...
        if (lowerCaseSqlType.contains("varchar")
                || lowerCaseSqlType.contains("char")
                || lowerCaseSqlType.contains("text")) {
            return "String";
        } else if (lowerCaseSqlType.contains("datetime")
                || lowerCaseSqlType.contains("time")
                || lowerCaseSqlType.contains("date")) {
            return "Date";
        } else if (lowerCaseSqlType.contains("bigint")
                || lowerCaseSqlType.contains("long")) {
            return "Long";
        } else if (lowerCaseSqlType.contains("int")) {
            return "Integer";
        } else if (lowerCaseSqlType.contains("decimal")) {
            return "BigDecimal";
        } else if (lowerCaseSqlType.contains("boolean")) {
            return "Boolean";
        } else {
            return "String";
        }
